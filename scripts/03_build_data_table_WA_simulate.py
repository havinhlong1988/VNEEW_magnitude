...
def compute_ml_values(amplitude_mm, distance_km):
    ...
    ML_hut, logA0_hut = hutton83(amplitude_um, distance_km, 0) # Hutton83 does not have correction term, always set to 0
    ML_le, logA0_le = le08(amplitude_um, distance_km, 0) # Le08 uses nm unit and does not have correction term, always set to 0
    # ML_le, logA0_le = le08(amplitude_nm, distance_km, 0) # Le08 uses nm unit and does not have correction term, always set to 0
    ML_ng, logA0_ng = nguyen11(amplitude_nm, distance_km, 0) # Nguyen11 does not have correction term, always set to 0  
