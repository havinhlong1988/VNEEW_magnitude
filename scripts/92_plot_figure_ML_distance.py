...
# INPUT / OUTPUT
# =========================================================
INPUT_CSV = Path("output/Vung_vres_ml_check/event_station_ml_vres.csv")
OUTFIG = Path("figures/vres_ml_check/00_ml_compare_use_vres.png")
...
title="Estimate from vres -> disp + highpass = 0.075Hz"
...
fig.legend(
    position="JBL+jBL+w3c/1.5c+o0.2c/0.2c",
    box="+gwhite"
    # box=True
)
