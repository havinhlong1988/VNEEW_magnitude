...
"""
05_regress_Mtc_tau_c.py

Regression for Mtc:

    Mtc = A + B*log10(tau) ± sigma_res
...
Outputs:
    output/05_regression_Mtc_tau_c/
        Mtc_regression_report.txt
        Mtc_regression_equation_summary.csv
        Mtc_regression_coefficients.csv
        Mtc_regression_predictions.csv
        Mtc_vs_header_ML.png
        Mtc_residual_hist.png
        Mtc_residual_vs_log10_tau.png
        Mtc_residual_vs_distance.png
"""
...
OUTPUT_DIR = Path("output/05_regression_Mtc_tau_c")

TAU_COL = "tau_c_3s_sec"
TAU_UNIT = "sec"
M_COL = "header_ML"
R_COL = "distance_km"
